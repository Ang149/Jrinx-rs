...
use jrinx_driver::net::net_buf::NetBufPtr;
use jrinx_driver::net::virtio_net::VirtIoNetMutex;
use jrinx_driver::VirtioNet;
use spin::{Mutex, Once};
...
static LISTEN_TABLE: Once<ListenTable> = Once::new();
static SOCKET_SET: Once<SocketSetWrapper> = Once::new();
